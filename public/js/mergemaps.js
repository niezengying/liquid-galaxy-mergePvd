   ...
   var baiduKey = config.baiduKey;
	 ...
	 var StreetViewStatus = {
		...
		function SetProvider(app) {
			apiProvider = pvdName2Id(app);
		}
		
		function setPvdIdx(pvdIdx) {
		apiProvider = pvdIdx;
		}
      ...
      case 2:
	    streetview = new QMaps.Panorama(div,opt); 
			streetview.getLinks = function(){
				...
				var thispano = streetview.getPano();
				var dir = 1;
				
				var links = null;
				//getPanoramaByOffset(fromloc, distance, heading, maxDis, function(ret){
